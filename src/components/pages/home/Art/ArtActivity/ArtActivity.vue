  ...
  <div id="PartyActivity">
    <div class="h_header">
      <p class="h_title">艺术素养
        <span class="h_sub_title">&nbsp;>参加艺术活动项目</span>
      </p>
    </div>
    <div class="section">
      <div class="navBar">
      ...
      <div class="bd_table">
        <div class="bd_content">
          ...
          >
            ...
            <el-table-column prop="pntXsszpjRckhOuts[0].khjg" label="参加艺术活动项目" width="200"></el-table-column>
            <el-table-column prop="pntXsszpjRckhOuts[1].khjg" label="级别" width="150"></el-table-column>
