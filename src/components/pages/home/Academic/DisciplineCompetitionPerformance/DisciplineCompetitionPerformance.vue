  ...
  <div id="PartyActivity">
    <div class="h_header">
      <p class="h_title">学业水平
        <span class="h_sub_title">&nbsp;>学科竞赛成绩</span>
      </p>
    </div>
    <div class="section">
      <div class="navBar">
      ...
      <div class="bd_table">
        <div class="bd_content">
          ...
          >
            ...
            <el-table-column prop="pntXsszpjRckhOuts[0].khjg" label="项目" width="180"></el-table-column>
            ...
            <el-table-column prop="pntXsszpjRckhOuts[3].khjg" label="时间" width="180"></el-table-column>
            <el-table-column prop="pntXsszpjRckhOuts[4].khjg" label="获得名次或等第" width="180"></el-table-column>
          </el-table>
        </div>
      </div>
    </div>
