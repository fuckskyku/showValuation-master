<template>
  <div id="PartyActivity">
    <div class="h_header">
      <p class="h_title">典型案例
        <span class="h_sub_title">&nbsp;>典型案例材料</span>
      </p>
    </div>
    <div class="section">
      <div class="navBar">
      ...
      <div class="bd_table">
        <div class="bd_content">
          ...
          >
            ...
            <el-table-column prop="pntXsszpjRckhOuts[0].khjg" label="材料类别" width="200"></el-table-column>
            <el-table-column prop="pntXsszpjRckhOuts[1].khjg" label="作品标题" width="200"></el-table-column>
            <el-table-column prop="pntXsszpjRckhOuts[2].khjg" label="指导教师" width="200"></el-table-column>
            <el-table-column prop="pntXsszpjRckhOuts[3].khjg" label="个人角色" width="200"></el-table-column>
          </el-table>
        </div>
      </div>
    </div>
