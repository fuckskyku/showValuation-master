  ...
  <div id="PartyActivity">
    <div class="h_header">
      <p class="h_title">思想品德
        <span class="h_sub_title">&nbsp;>先进个人荣誉项目</span>
      </p>
    </div>
    <div class="section">
      <div class="navBar">
      ...
      <div class="bd_table">
        <div class="bd_content">
          <el-table
            ...
            style="width: 1010px"
          >
            <el-table-column prop="xjh" label="号数" width="180"></el-table-column>
            <el-table-column prop="xm" label="姓名" width="110"></el-table-column>
            <el-table-column prop="pntXsszpjRckhOuts[0].khjg" label="先进个人荣誉称号" width="178"></el-table-column>
            <el-table-column prop="pntXsszpjRckhOuts[1].khjg" label="时间" width="180"></el-table-column>
            <el-table-column prop="pntXsszpjRckhOuts[2].khjg" label="级别" width="180"></el-table-column>
            <el-table-column prop="pntXsszpjRckhOuts[3].khjg" label="评选单位" width="180"></el-table-column>
