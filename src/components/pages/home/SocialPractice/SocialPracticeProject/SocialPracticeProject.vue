  ...
  <div id="PartyActivity">
    <div class="h_header">
      <p class="h_title">社会实践
        <span class="h_sub_title">&nbsp;>社会实践参与项目</span>
      </p>
    </div>
    <div class="section">
      <div class="navBar">
      ...
      <div class="bd_table">
        <div class="bd_content">
          ...
          >
            ...
            <el-table-column prop="xsPntXsszpjRckhSjTimes[0].khjg" label="项目" width="200"></el-table-column>
            <el-table-column prop="xsPntXsszpjRckhSjTimes[1].khjg" label="累计次数" width="200"></el-table-column>
            <el-table-column prop="xsPntXsszpjRckhSjTimes[2].khjg" label="累计时间" width="200"></el-table-column>
            <el-table-column prop="xsPntXsszpjRckhSjTimes[3].khjg" label="组织单位" width="200"></el-table-column>
          </el-table>
        </div>
      </div>
    </div>
