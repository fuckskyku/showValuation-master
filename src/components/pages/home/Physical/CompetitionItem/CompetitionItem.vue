  ...
  <div id="PartyActivity">
    <div class="h_header">
      <p class="h_title">身心健康
        <span class="h_sub_title">&nbsp;>参加体育比赛项目</span>
      </p>
    </div>
    <div class="section">
      <div class="navBar">
      ...
      <div class="bd_table">
        <div class="bd_content">
          ...
          >
            ...
            <el-table-column prop="pntXsszpjRckhOuts[0].khjg" label="参加体育比赛项目" width="200"></el-table-column>
            <el-table-column prop="pntXsszpjRckhOuts[1].khjg" label="级别" width="180"></el-table-column>
            <el-table-column prop="pntXsszpjRckhOuts[2].khjg" label="主办单位" width="180"></el-table-column>
            <el-table-column prop="pntXsszpjRckhOuts[3].khjg" label="时间" width="150"></el-table-column>
            <el-table-column prop="pntXsszpjRckhOuts[4].khjg" label="名次或等第" width="150"></el-table-column>
          </el-table>
        </div>
      </div>
    </div>
